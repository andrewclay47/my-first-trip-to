// ISO 3166-1 alpha-2 codes; names come from the browser's Intl API so we
// don't have to maintain a 200-entry name list ourselves.
const COUNTRY_CODES = [
...
export const COUNTRIES: string[] = COUNTRY_CODES.map(
